...
export function SalesPage() {
  ...
  return <>
    ...
    <main id="conteudo">
      ...
      <Section className="material-section"><div className="shell"><div className="section-heading centered reveal"><p className="eyebrow">Material por dentro</p><h2>Veja o que você recebe</h2><p>Um método direto e organizado para orientar cada etapa da sua recolocação profissional.</p></div><div className="material-grid"><figure className="material-mockup reveal"><Image src="/og.png" alt="Mockup do método Emprego Rápido, de Carolina Moura" width={1731} height={909} loading="lazy" sizes="(max-width: 767px) 92vw, 560px" /></figure><div className="material-details reveal"><p className="material-intro">Você recebe o <strong>Emprego Rápido</strong> em formato digital, com conteúdo prático para consultar sempre que estiver buscando uma nova oportunidade.</p><div className="material-items"><article><Icon name="file" /><div><h3>Guia digital completo</h3><p>40 páginas com um passo a passo claro para organizar sua busca e fortalecer sua apresentação profissional.</p></div></article><article><Icon name="filter" /><div><h3>Currículo, ATS e LinkedIn</h3><p>Orientações para criar um currículo estratégico, usar palavras-chave e melhorar sua presença nas plataformas de vagas.</p></div></article><article><Icon name="target" /><div><h3>Estratégia de candidatura</h3><p>Um método para escolher oportunidades, apresentar seus diferenciais e se posicionar com mais clareza.</p></div></article><article><Icon name="briefcase" /><div><h3>Entrevistas e exercícios práticos</h3><p>Preparação para falar sobre suas experiências com confiança e atividades para aplicar o conteúdo no seu ritmo.</p></div></article></div><p className="material-access"><Icon name="check" /> Acesso digital imediato pelo celular, computador ou tablet.</p></div></div></div></Section>
