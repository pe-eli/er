...
function BookMockup({ priority = false }: { priority?: boolean }) {
  return <div className="book-stage" aria-label="Capa do ebook Emprego Rápido"><div className="book-shadow" /><div className="book"><span className="book-spine" aria-hidden="true" /><Image src="/assets/ebook-cover.webp" alt="Capa do ebook Emprego Rápido, de Carolina Moura" width={982} height={1389} priority={priority} sizes="(max-width: 767px) 58vw, 390px" /></div><div className="device" aria-hidden="true"><div className="device-notch" /><Image src="/assets/ebook-summary.webp" alt="" fill sizes="150px" /></div></div>;
}
